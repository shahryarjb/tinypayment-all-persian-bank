...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(JPATH_SITE. '/media/com_tinypayment/images/pdf/');
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'tinypayment_invoice_logo.jpg')) {
		$tcpdf_header_logo = 'tinypayment_invoice_logo.jpg';
	}
